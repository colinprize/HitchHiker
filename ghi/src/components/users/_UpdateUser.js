            ...
            <div className="flex items-center justify-center mb-0">
                <div className="flex-col items-center mt-5">
                    <form className="bg-wheat shadow-md rounded px-20 pt-6 pb-8 mb-4">
                        ...
                        <div className="justify-center items-center mt-5 appearance-none block w-full bg-olivine text-white hover:scale-95 font-bold py-2 px-20 rounded-lg" >
                        ...
                        <div>
                        <button onClick={() => setContactPopup(true)} className="justify-center items-center mt-5 appearance-none block w-full bg-olivine text-white hover:scale-95 font-bold py-2 px-20 rounded-lg" type="button" >Add/Update an emergency contact</button>
