        ...
        <>
            <div className="flex items-center justify-center mb-0">
                <div className="flex flex-col items-center">
                    ...
                    <div>
                        <button onClick={() => setContactPopup(true)} className="bg-olivine hover:bg-beryl-green font-bold py-2 px-20 rounded" type="button" >Add/Update an emergency contact</button>
